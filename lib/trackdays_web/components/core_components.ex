defmodule TrackdaysWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TrackdaysWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TrackdaysWeb.Gettext, "errors", msg, opts)
    end
  end
