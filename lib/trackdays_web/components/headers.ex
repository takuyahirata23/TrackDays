defmodule TrackdaysWeb.Headers do
      ...
      <div class="relative">
        ...
        >
          <ul class="flex flex-col gap-y-4">
            ...
            <li>
              <.link navigate={~p"/admin/business/organizations"}>Organizations</.link>
            </li>
            <li>
              <.link navigate={~p"/admin/business/register-trackday"}>Register Trackday</.link>
            </li>
            <li>
              <.link navigate={~p"/admin/login"}>Log in</.link>
            </li>
          </ul>
        </nav>
      </div>
  ...
  def root(assigns) do
    ~H"""
    <header class="bg-bg-secondary">
      <div class="max-w-6xl w-11/12 mx-auto z-50 sticky">
        <div class="flex justify-between items-center">
          <a href="/">
            <div class="w-40 -ml-4 md:w-52">
          ...
          <div class="hidden md:block">
            <ul class="flex gap-x-4">
              <li>
                <.link navigate={~p"/admin/login"}>Admin</.link>
              </li>
            </ul>
          </div>
        </div>
        <div class="relative">
          <div id="backdrop" class="z-10 fixed h-screen inset-x-0 bg-bg-tertiary opacity-50 hidden" />
          <nav
            id="mobile-navigation"
            class="z-20 fixed bg-bg-secondary h-screen right-0  drop-shadow-md hidden w-2/3 p-8"
          >
