defmodule Trackdays.Repo.Migrations.AddTrackdaysAndOrganizations do
  ...
  def change do
    ...
    create table(:trackdays, primary_key: false) do
      ...
      add :organization_id, references(:organizations, type: :binary_id, on_delete: :nothing, null: false)
      timestamps()
    end

    create(index(:trackdays, [:date]))
    create(unique_index(:trackdays, [:organization_id, :date], name: :trackdays_constraint))
  end
end
